...
builder.Services.AddSingleton<IAuthorizationPolicyProvider, MinExpPolicyProvider>();
builder.Services.AddSingleton<IAuthorizationHandler, MinExpAuthorizationHandler>();
#endregion
