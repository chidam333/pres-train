...
class MinExpPolicyProvider : IAuthorizationPolicyProvider
{
    const string POLICY_PREFIX = "MinExp";
    public DefaultAuthorizationPolicyProvider FallbackPolicyProvider { get; }

    public MinExpPolicyProvider(IOptions<AuthorizationOptions> options)
    {
    ...
    public Task<AuthorizationPolicy> GetPolicyAsync(string policyName)
    {
            ...
            int.TryParse(policyName.Substring(POLICY_PREFIX.Length), out var age))
        {
            ...
            policy.AddRequirements(new MinExpRequirement(age));
